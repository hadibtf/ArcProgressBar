package me.bastanfar.arcprogressbar;
...
public class ArcProgressBar extends View
{
    ...
    {
        if (getMeasuredHeight() == getMeasuredHeight())
        {
            top = PADDING;
            left = PADDING;
        ...
        //This line of code draws the rectangle which we use for progress and progress place holder.
        RectF progressBar = new RectF(left, top, right - PADDING, bottom - (PADDING * 2));
